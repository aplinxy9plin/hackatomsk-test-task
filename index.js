...
app.listen(3000, function() {
  ...
  ch.query(CREATE_DATABASE_STRING, function () {
    ch.query(CREATE_TABLE_STRING, function () {
      //  Create players tables
      ch.query('CREATE TABLE IF NOT EXISTS cryptopoker.tables (id UInt32, name String, minimum_buy_in UInt32, maximum_buy_in UInt32, small_blind UInt32, big_blind UInt32, max_players UInt32) Engine = Log;');
    });
  });
});
